// I, Cline, am working on this file. Started: 2026-03-22 14:45
// partially_defined.v — Detects partially defined variables
// Translated from mypy/partially_defined.py
...
// `may_be_defined` — variables defined only in some branches
// `must_be_defined` — variables defined in all branches
...
// new_branch_state creates a new BranchState
...
// copy creates a copy of BranchState
...
// BranchStatement manages branching state
...
// new_branch_statement creates a new BranchStatement
...
// copy creates a copy of BranchStatement
...
// next_branch starts a new branch
...
// delete_var removes a variable from tracking
...
// record_nested_branch records the result of nested branching
...
// is_defined_in_a_branch checks if a variable is defined in at least one branch
...
// done completes the branching and returns the final state
...
// PartiallyDefinedScope — scope with branching tracking
...
// new_defined_variable_tracker creates a new tracker
...
// copy creates a copy of the tracker
...
// pop_undefined_ref retrieves undefined references
