...
pub fn generator_emit_global_helpers(imports []string, structs []string, functions []string, module_name string, classes []string) string {
	return VCodeEmitter.emit_global_helpers(imports, structs, functions, module_name, classes)
}
